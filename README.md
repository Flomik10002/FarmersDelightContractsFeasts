...
**Requires [Farmer's Delight](https://www.curseforge.com/minecraft/mc-mods/farmers-delight) 1.20.1-1.3+ — Forge (also runs on NeoForge 1.20.1 unmodified), Minecraft 1.20.1.**
...
| Forge *(this branch)* | 1.20.1 | `forge/1.20.1` | [Farmer's Delight](https://www.curseforge.com/minecraft/mc-mods/farmers-delight) 1.20.1-1.3+ |
