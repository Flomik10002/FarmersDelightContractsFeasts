...
**Requires [Farmer's Delight](https://www.curseforge.com/minecraft/mc-mods/farmers-delight) 1.2.4+ — NeoForge, Minecraft 1.21.1.**
...
| --- | --- | --- | --- |
| NeoForge *(this branch)* | 1.21.1 | `neoforge/1.21.1` | [Farmer's Delight](https://www.curseforge.com/minecraft/mc-mods/farmers-delight) 1.2.4+ |
